...
- 🚀 Passionate about **Recommender Systems** and **Machine Learning**  
- 💻 Currently working with **MATLAB** on advanced projects  
- 🌱 Always eager to learn new technologies and tools  
- 💬 Let's connect: [andrea.email@example.com](mailto:andrea.email@example.com)  
...
- **Tools**: `Git`, `Microsoft Office Suite`, `LaTeX`  
